...
if __name__ == "__main__":
    ...
    spark.sql("""
        CREATE TABLE IF NOT EXISTS bronze.org-type
        USING delta
        LOCATION 's3a://lakehouse/bronze/org-type'
    """)
    ...
    CHECKPOINT_PATH = "s3a://lakehouse/checkpoints/org-type"
    ...
    delta_query = (
        ...
        .start("s3a://lakehouse/bronze/org-type")
        #.start()
    )
