...
if __name__ == "__main__":
    ...
    spark.sql("""
        CREATE TABLE IF NOT EXISTS bronze.wfp-market
        USING delta
        LOCATION 's3a://lakehouse/bronze/wfp-market'
    """)
    ...
    CHECKPOINT_PATH = "s3a://lakehouse/checkpoints/wfp-market"
    ...
    delta_query = (
        ...
        .start("s3a://lakehouse/bronze/wfp-market")
        #.start()
    )
