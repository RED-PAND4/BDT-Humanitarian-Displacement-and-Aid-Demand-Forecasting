...
if __name__ == "__main__":
    ...
    spark.sql("""
        CREATE TABLE IF NOT EXISTS bronze.foodsecurity
        USING delta
        LOCATION 's3a://lakehouse/bronze/foodsecurity'
    """)
    ...
    CHECKPOINT_PATH = "s3a://lakehouse/checkpoints/bronze/foodsecurity"
    ...
    delta_query = (
        ...
        .start("s3a://lakehouse/bronze/foodsecurity")
        #.start()
    )
