...
if __name__ == "__main__":
    spark = get_spark_session("KafkaToBronze-Org")
    ...
    spark.sql("""
        CREATE TABLE IF NOT EXISTS bronze.org
        USING delta
        LOCATION 's3a://lakehouse/bronze/org'
    """)
    ...
    CHECKPOINT_PATH = "s3a://lakehouse/checkpoints/bronze/org"
    ...
    delta_query = (
        ...
        .start("s3a://lakehouse/bronze/org")
        #.start()
    )
