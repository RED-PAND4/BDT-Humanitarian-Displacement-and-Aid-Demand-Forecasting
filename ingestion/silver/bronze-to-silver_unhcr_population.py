...
if __name__ == "__main__":
    ...
    # ==========================================
    spark = get_spark_session("BronzeToSilver-UNHCR-Population")
    ...
    # ==========================================
    # Convert placeholder "-" in 'oip' to NULL and cast to Integer
    ...
    # ==========================================
    # Business keys identifying unique annual origin-destination population flows:
    subset_cols = [
        "year",
        "coo_iso",
        "coa_iso"
