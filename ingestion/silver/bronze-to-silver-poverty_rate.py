...
spark = get_spark_session("BronzeToSilver-PR")
...
spark.sql("""
    CREATE TABLE IF NOT EXISTS silver.povertyrate
    USING delta
    LOCATION 's3a://lakehouse/silver/povertyrate'
""")
...
#     .format("delta")
#     .outputMode("append")
#     .option("checkpointLocation", "s3a://lakehouse/checkpoints/silver/povertyrate")
#     .trigger(availableNow=True) # 👈 THE MAGIC TRICK: Process new data and shut down
#     .start("s3a://lakehouse/silver/povertyrate"))
