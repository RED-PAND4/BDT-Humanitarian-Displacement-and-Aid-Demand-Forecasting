...
if __name__ == "__main__":
    ...
    # ==========================================
    # Drop records missing critical location, sector identifier, or population figure
    cleaned_df = bronze_df.dropna(subset=["location_code", "population", "sector_code"])

    # ==========================================
    # PHASE 4: Clean and Deduplicate Data
    # ==========================================
    # Deduplication business keys: unique assessment identifiers excluding descriptive names and metrics
    subset_cols = [
        "location_code",
        "admin1_code",
        "admin2_code",
        ...
        "category",
        "population_status",
        # "population",     # -> we could have a rectification of the number of people, and it should be updated
