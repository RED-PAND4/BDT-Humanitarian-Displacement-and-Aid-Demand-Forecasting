...
spark.sql("""
    CREATE TABLE IF NOT EXISTS silver.wfpcommodity
    USING delta
    LOCATION 's3a://lakehouse/silver/wfpcommodity'
""")
...
#     .format("delta")
#     .outputMode("append")
#     .option("checkpointLocation", "s3a://lakehouse/checkpoints/silver/wfpcommodity")
