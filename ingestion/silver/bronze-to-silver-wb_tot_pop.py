...
if __name__ == "__main__":
    ...
    # ==========================================
    spark = get_spark_session("BronzeToSilver-WorldBank-Population")
    ...
    # ==========================================
    # Business keys identifying unique annual World Bank population records:
    subset_cols = [
        "location_code",
        "year"
        # "total_population"  # Excluded: numeric metric subject to retroactive adjustments
    ]
